"""
Django settings for txtkeep project.
...
# Optional settings
AWS_QUERYSTRING_AUTH = False  # Disables query string authentication, makes files publicly accessible if bucket permissions allow
...
WSGI_APPLICATION = 'txtkeep.wsgi.application'
